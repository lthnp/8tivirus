...
(function (b) {
  b.fn.pagepiling = function (c) {
    ...
    function g(a, f) {
      ...
      d.activeSection.is(a) || ("undefined" === typeof d.animated && (d.animated = !0), "undefined" !== typeof d.anchorLink && c.anchors.length && (location.hash = d.anchorLink), d.destination.addClass("active").siblings().removeClass("active"), d.sectionsToMove = B(d), "down" === d.yMovement ? (d.translate3d = "vertical" !== c.direction ? "translate3d(-100%, 0px, 0px)" : "translate3d(0px, -100%, 0px)", d.scrolling = "-100%", c.css3 || d.sectionsToMove.each(function (a) {
        a != d.activeSection.index(".pp-section") && b(this).css(m(d.scrolling));
      }), d.animateSection = d.activeSection) : (d.translate3d = "translate3d(0px, 0px, 0px)", d.scrolling = "0", d.animateSection = a), b.isFunction(c.onLeave) && c.onLeave.call(this, d.leavingSection, d.sectionIndex + 1, d.yMovement), C(d), D(d.anchorLink), E(d.anchorLink, d.sectionIndex), r = d.anchorLink, s = new Date().getTime());
    }

    function C(a) {
      c.css3 ? (t(a.animateSection, a.translate3d, a.animated), a.sectionsToMove.each(function () {
        t(b(this), a.translate3d, a.animated);
      }), setTimeout(function () {
        u(a);
      }, c.scrollingSpeed)) : (a.scrollOptions = m(a.scrolling), a.animated ? a.animateSection.animate(a.scrollOptions, c.scrollingSpeed, c.easing, function () {
        n(a);
        n(a);
      }) : (a.animateSection.css(m(a.scrolling)), setTimeout(function () {
        n(a);
        u(a);
      }, 400)));
    }
    ...
    function B(a) {
      return "down" === a.yMovement ? b(".pp-section").map(function (c) {
        if (c < a.destination.index(".pp-section")) return b(this);
      }) : b(".pp-section").map(function (c) {
        if (c > a.destination.index(".pp-section")) return b(this);
      });
    }

    function n(a) {
      "up" === a.yMovement && a.sectionsToMove.each(function (c) {
        b(this).css(m(a.scrolling));
      });
    }
    ...
    function p() {
      return new Date().getTime() - s < 600 + c.scrollingSpeed ? !0 : !1;
    }
    ...
    function k(a, c) {
      if ("down" == a) var d = "bottom",
          e = b.fn.pagepiling.moveSectionDown;else d = "top", e = b.fn.pagepiling.moveSectionUp;
      if (0 < c.length) {
        if (isScrolled(d, c)) e();else return !0;
      } else e();
    }
    ...
    function y(a, f) {
      f = f || 0;
      var d = b(a).parent();
      return f < c.normalScrollElementTouchThreshold && d.is(c.normalScrollElements) ? !0 : f == c.normalScrollElementTouchThreshold ? !1 : y(d, ++f);
    }
    ...
    function H() {
      ...
      for (var f = 0; f < b(".pp-section").length; f++) {
        var d = "";
        c.anchors.length && (d = c.anchors[f]);
    ...
    function I() {
      ...
      for (var e in c) {
        void 0 !== a.style[e] && (a.style[e] = "translate3d(1px,1px,1px)", b = window.getComputedStyle(a).getPropertyValue(c[e]));
      }
    ...
    var e = b(this),
        r,
        s = 0,
        z = "ontouchstart" in window || 0 < navigator.msMaxTouchPoints,
        l = touchStartX = touchEndY = touchEndX = 0;
    c = b.extend({
      direction: "vertical",
      menu: null,
      verticalCentered: !0,
    ...
    b.fn.pagepiling.setAllowScrolling = function (a) {
      a ? (b.fn.pagepiling.setMouseWheelScrolling(!0), z && (MSPointer = w(), e.off("touchstart " + MSPointer.down).on("touchstart " + MSPointer.down, F), e.off("touchmove " + MSPointer.move).on("touchmove " + MSPointer.move, G))) : (b.fn.pagepiling.setMouseWheelScrolling(!1), z && (MSPointer = w(), e.off("touchstart " + MSPointer.down), e.off("touchmove " + MSPointer.move)));
    };
    ...
    b.isEmptyObject(c.navigation) || H();
    var q = b(".pp-section").length;
    b(".pp-section").each(function (a) {
      b(this).data("data-index", a);
      b(this).css("z-index", q);
    ...
    b(window).on("hashchange", function () {
      ...
      a.length && a && a !== r && (a = isNaN(a) ? b('[data-anchor="' + a + '"]') : b(".pp-section").eq(a - 1), g(a));
    });
    ...
    c.normalScrollElements && (b(document).on("mouseenter", c.normalScrollElements, function () {
      b.fn.pagepiling.setMouseWheelScrolling(!1);
    }), b(document).on("mouseleave", c.normalScrollElements, function () {
      b.fn.pagepiling.setMouseWheelScrolling(!0);
    }));
