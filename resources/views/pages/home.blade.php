...
<div class="wrapper" >
    ...
    <main>
        <div class="row">
            <section data-anchor="Page 1" style="margin-top: 3%;">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-6 bg-logo" style="z-index: 99;">
                                <img src="images/hand_home.png" class="hand">
                            </div>
                            <div class="col-6 bg-menu" style="margin-top: 5%; ">
                                <div class="text_menu" style=" margin-left: 10%; height: 100%;">
                                    <div class="icon_zone">
                                        <div class="txt text-end fw-bolder" style="font-family: 'IBM Plex Sans Thai Bold'; font-size: 32px;">
                                    ...
                                    <div class="icon_zone">
                                        <div class="txt text-end fw-bolder" style="font-size: 32px;">
                            ...
                            <div class="center" style="margin-left: 5%; z-index: -99;">
                                <div class="photomoilehome" >
                                    <video autoplay muted loop playsinline preload="metadata" class="videofilterhome">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-4 col-lg-2 photo-pad2">
                                <div class="photomoile">
                                    <iframe id="vdo2" class="videoStaffPick" src="https://www.youtube.com/embed/Cu2D13tNAZw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            ...
                            <div class="col-4 col-lg-2 photo-pad3">
                                <div class="photomoile">
                                    <iframe id="vdo3" class="videoStaffPick" src="https://www.youtube.com/embed/Cu2D13tNAZw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            ...
                            <div class="col-4 col-lg-2 photo-pad2">
                                <div class="photomoile">
                                    <iframe id="vdo4" class="videoStaffPick" src="https://www.youtube.com/embed/Cu2D13tNAZw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    ...
                                    <div class="centerlookingfor" style="margin-top: 8%;">
                                        <div class="icon-pad1">
                                            <div class="lookingforicon">
                                                <img src="{{ asset('assets/images/iconcode.png') }}" alt="Coding">
                                            </div>
                                            <div class="txt-staff">
...
<script>
    let vdo1 = 'https://www.youtube.com/embed/Cu2D13tNAZw?autohide=1&showinfo=0&controls=0'
    let vdo2 = 'https://www.youtube.com/embed/tzg0PIB-FyU?autohide=1&showinfo=0&controls=0'
    let vdo3 = 'https://www.youtube.com/embed/11YHE6h9GBk?autohide=1&showinfo=0&controls=0'
    let vdo4 = 'https://www.youtube.com/embed/4CuYyR2ENu8?autohide=1&showinfo=0&controls=0'
    ...
    $('.mockupbest1').click(function () {
        let v = $('#vdo1').attr('src');
        if(v == vdo1){
            $('#vdo1').get(0).playVideo();
            $('#vdo2').get(0).stopVideo();
            $('#vdo3').get(0).stopVideo();
            $('#vdo4').get(0).stopVideo();
        } else {
            $('#vdo1').get(0).stopVideo();
        }
    })
